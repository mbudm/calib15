	...
	var calibUi = {
		...
		checkEnvironment:function(ma){
			...
			if(this.categoriseAxis('yaw',this.movingAverages[ma].yaw,(this.yawRange * 1.5) ) !== "center" && this.categoriseAxis('pitch',this.movingAverages[ma].pitch,(this.pitchRange * 1.5) ) ){
