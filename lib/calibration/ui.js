...
{"up":-0.40073136119999997,"down":0.5356747272,"left":0.9974491569999999,"right":-0.066575312}
		...
		*/
		...
		thresholdProportion:0.4, //determines the thresholds from limits
		...
		captureCentrePosition:function(ma){
			//store the x and y as the users natural center
			this.currentCentre = {
				yaw:this.movingAverages[ma].yaw,
				pitch:this.movingAverages[ma].pitch
			};
		}
	};